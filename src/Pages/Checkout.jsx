                        ...
                        <Row>
                            <Col className='mb-4 md:mb-0' md={8}>
                                <Form.Group className='mb-3'>
                                    ...
                                    <Form.Select name="country" value={formData.country} onChange={handleChange} aria-label="Select country" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]'>
                                ...
                                <Form.Group className='mb-3'>
                                    ...
                                    <Form.Control name="fullName" value={formData.fullName} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="Full name" />
                                </Form.Group>

                                <Row>
                                    <Col md={6}>
                                        <Form.Group className='mb-3'>
                                            <Form.Control name="email" value={formData.email} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="Email address" />
                                        </Form.Group>
                                    </Col>
                                    <Col md={6}>
                                        <Form.Group className='mb-3'>
                                            <Form.Control name="phone" value={formData.phone} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="Phone number" />
                                        </Form.Group>
                                    </Col>
                                </Row>
                                <Form.Group className='mb-3'>
                                    <Form.Control name="street" value={formData.street} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="Enter street name and house number" />
                                </Form.Group>

                                <Row>
                                    <Col md={6}>
                                        <Form.Group className='mb-3'>
                                            <Form.Control name="city" value={formData.city} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="City" />
                                        </Form.Group>
                                    </Col>
                                    <Col md={6}>
                                        <Form.Group className='mb-3'>
                                            <Form.Select name="region" value={formData.region} onChange={handleChange} aria-label="Select region" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]'>
                                ...
                                <Form.Group className='mb-3'>
                                    <Form.Control name="postal" value={formData.postal} onChange={handleChange} type="text" className='text-[12px] lg:text-[14px] h-[56px] outline-none shadow-none border-[#E5E5E5] rounded-[8px] focus:border-[#E5E5E5]' placeholder="Enter your postal code" />
                                </Form.Group>
