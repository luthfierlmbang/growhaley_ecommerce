    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={openAdd} className="h-[44px] px-5 rounded-full bg-[#E16F3D] text-white text-[14px] font-medium hover:bg-[#c85e2e] transition-colors flex items-center gap-2">
