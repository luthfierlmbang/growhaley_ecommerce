...
const seedOrders = () => {
    ...
    const items    = [
        [{ name: 'Winter Coat',    price: '144.99', qty: 1, img: '/images/p (2).png', selectedSize: 'M', selectedColor: '#CDBF9A' }],
        [{ name: 'Autumn Dress',   price: '124.99', qty: 2, img: '/images/p (3).png', selectedSize: 'S', selectedColor: '#D574B2' }],
        [{ name: 'Casual T-Shirt', price: '39.99',  qty: 3, img: '/images/p (1).png', selectedSize: 'L', selectedColor: '#171717' }],
        [{ name: 'Slim Jeans',     price: '89.99',  qty: 1, img: '/images/p (2).png', selectedSize: 'M', selectedColor: '#614126' }],
        [{ name: 'Denim Jacket',   price: '159.99', qty: 1, img: '/images/p (3).png', selectedSize: 'XL', selectedColor: '#838382' }],
        [{ name: 'Sneakers Pro',   price: '119.99', qty: 2, img: '/images/p (1).png', selectedSize: '42', selectedColor: '#171717' }],
    ]
...
export const AdminProvider = ({ children }) => {
    ...
    /* ── Orders ── */
    const updateOrderStatus = (ref, status) =>
